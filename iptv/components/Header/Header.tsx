...
//   ];
//   return (
//     <ul className='hidden md:flex ml-auto  tracking-wider '>
//       {navLinks.map((link) => (
//         <li
//           key={link.id}
...
const Header = () => {
  return (
    <div className="bg-neutral-600/70c nbg-white h-16  flex items-center md:px-16 px:6 relative transition shadow-sm px-6">
      <Logo />
      <Navbar />
    </div>
  );
